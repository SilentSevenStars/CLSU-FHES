                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center py-4 border-b">
                        ...
                        <div class="col-span-3">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['education_qualification'];
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center py-4 border-b">
                        ...
                        <div class="col-span-3">
                            <input type="number" 
                                   ...
                                   placeholder="Input here"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0A6025] focus:border-[#0A6025] transition-all">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['experience_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center py-4 border-b">
                        ...
                        <div class="col-span-3">
                            <input type="number" 
                                   ...
                                   placeholder="Input here"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0A6025] focus:border-[#0A6025] transition-all">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['licensure_examination'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center py-4 border-b">
                        ...
                        <div class="col-span-3">
                            <select wire:model.live="place_board_exam"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $placeBoardExamOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            </select>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['place_board_exam'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                    ...
                    <div class="grid grid-cols-12 gap-4 items-start py-4 border-b">
                        ...
                        <div class="col-span-3">
                            <input type="number" 
                                   ...
                                   placeholder="Input here"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0A6025] focus:border-[#0A6025] transition-all">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['professional_activities'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center py-4 border-b">
                        ...
                        <div class="col-span-3">
                            <select wire:model.live="academic_performance"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0A6025] focus:border-[#0A6025] appearance-none bg-white transition-all">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $academicPerformanceOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            </select>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['academic_performance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center py-4 border-b">
                        ...
                        <div class="col-span-3">
                            <select wire:model.live="publication"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0A6025] focus:border-[#0A6025] appearance-none bg-white transition-all">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $publicationOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            </select>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['publication'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center py-4 border-b">
                        ...
                        <div class="col-span-3">
                            <select wire:model.live="school_graduate"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0A6025] focus:border-[#0A6025] appearance-none bg-white transition-all">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $schoolGraduateOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            </select>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['school_graduate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center py-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg px-4 border-l-4 border-gray-400">
                        ...
                        <div class="col-span-3 text-center">
                            <span class="text-xl font-bold text-gray-800"><?php echo e(number_format($totalScore, 2)); ?></span>
                        </div>
                    </div>

                    <!-- Overall Total Score Display -->
                    <!--[if BLOCK]><![endif]--><?php if($totalScore > 0): ?>
                    <div class="grid grid-cols-12 gap-4 items-center py-6 bg-gradient-to-r from-[#0A6025]/10 to-green-50 rounded-lg px-4 border-l-4 border-[#0A6025] mt-4">
                        ...
                        <div class="col-span-3 text-center">
                            <span class="text-3xl font-bold text-[#0A6025]"><?php echo e(number_format($totalScore, 2)); ?></span>
                        </div>
                    </div>
        ...
        >
            <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-lg bg-white">
                ...
                <div class="space-y-4">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($applicant->region || $applicant->city): ?>
                    <div class="pt-4 border-t">
                        <p class="text-sm font-medium text-gray-500 mb-2">Address</p>
                        <p class="text-base text-gray-900">
                            <?php echo e(collect([$applicant->street, $applicant->barangay, $applicant->city, $applicant->province, $applicant->region])->filter()->join(', ')); ?>

                        </p>
                    </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                    <!--[if BLOCK]><![endif]--><?php if($jobApplication->requirements_file): ?>
                    <div class="pt-4 border-t">
                        <p class="text-sm font-medium text-gray-500 mb-2">Requirements File</p>
                        <a href="<?php echo e(Storage::url($jobApplication->requirements_file)); ?>" 
                           target="_blank"
            ...
            Livewire.on('showSwalConfirm', () => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').saveExperience();
                    }
                });
            });
...
</div><?php /**PATH C:\xampp\htdocs\CLSU-FHES\resources\views/livewire/panel/experience.blade.php ENDPATH**/ ?>