                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div class="flex items-center gap-3">
                            <div class="bg-white/20 backdrop-blur-sm rounded-lg p-2">
                                <i class="fa-solid fa-university text-white text-lg"></i>
                            </div>
                            <h2 class="text-2xl font-bold text-white">Colleges List</h2>
                        </div>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-300">
                                        <thead class="bg-gray-200">
                                            <tr>
                                                ...
                                                <th scope="col" class="px-6 py-3 text-start">
                                                    <span class="text-xs font-semibold uppercase text-black">College Name</span>
                                                </th>
                                                <th scope="col" class="px-6 py-3 text-start">
                                        ...
                                        <tbody class="divide-y divide-gray-300 bg-gray-50">
                                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $colleges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $college): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr class="bg-gray-50 hover:bg-gray-100">
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-black font-medium">
                                                    <?php echo e($college->id); ?>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-black">
                                                    <?php echo e($college->created_at?->format('M d, Y h:i A') ?? 'N/A'); ?>

                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                    <button wire:click="edit(<?php echo e($college->id); ?>)"
                                                        class="text-white bg-yellow-500 hover:bg-yellow-600 rounded-lg px-3 py-1 text-sm font-medium">
                                                        Edit
                                                    </button>
                                                    <button wire:click="confirmDelete(<?php echo e($college->id); ?>)"
                                            ...
                                            <tr>
                                                <td colspan="4" class="text-center py-8 text-gray-500">
                                                    <div class="flex flex-col items-center justify-center">
                                                        ...
                                                        <p class="text-lg font-medium">No colleges found</p>
            ...
            <div @click.away="$wire.closeModal()" class="bg-white rounded-lg shadow-xl max-w-md w-full">
                <div class="bg-green-600 px-6 py-4 rounded-t-lg">
                    <h3 class="text-xl font-bold text-white">
                        <?php echo e($editMode ? 'Edit' : 'Create'); ?> College
                    </h3>
                </div>
                    ...
                    <div class="p-6">
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   wire:model="name" 
                                   id="name"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 <?php $__errorArgs = ['name'];
...
</div><?php /**PATH C:\xampp\htdocs\CLSU-FHES\resources\views/livewire/admin/college-manager.blade.php ENDPATH**/ ?>