                ...
                <span>
                    ...
                    <?php else: ?>
                        <button type="button"
                            ...
                            class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-green-300 active:bg-gray-100 transition ease-in-out duration-150">
                            <?php echo __('pagination.previous'); ?>
                ...
                <span>
                    <!--[if BLOCK]><![endif]--><?php if($paginator->hasMorePages()): ?>
                        <button type="button"
                            ...
                            class="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-green-300 active:bg-gray-100 transition ease-in-out duration-150">
                        ...
                        <span>
                            ...
                            <?php else: ?>
                                <button type="button"
                                    ...
                                    class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-l-md leading-5 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-green-300 active:bg-gray-100 transition ease-in-out duration-150"
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(is_string($element)): ?>
                                <span aria-disabled="true">
                                    <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-600 bg-white border border-gray-300 cursor-default leading-5"><?php echo e($element); ?></span>
                                </span>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <span wire:key="paginator-<?php echo e($paginator->getPageName()); ?>-page<?php echo e($page); ?>">
                                        <!--[if BLOCK]><![endif]--><?php if($page == $paginator->currentPage()): ?>
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-semibold text-white bg-[#1E7F3E] border border-gray-300 cursor-default leading-5"><?php echo e($page); ?></span>
                                            </span>
                                        <?php else: ?>
                                            <button type="button"
                                                wire:click="gotoPage(<?php echo e($page); ?>, '<?php echo e($paginator->getPageName()); ?>')"
                                                x-on:click="<?php echo e($scrollIntoViewJsSnippet); ?>"
                                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-green-300 active:bg-gray-100 transition ease-in-out duration-150"
                        ...
                        <span>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($paginator->hasMorePages()): ?>
                                <button type="button"
                                    ...
                                    class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-r-md leading-5 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-green-300 active:bg-gray-100 transition ease-in-out duration-150"
...
<?php /**PATH C:\Users\admin\Documents\GitHub\Git Uploads\CLSU-FHES\resources\views/vendor/livewire/tailwind.blade.php ENDPATH**/ ?>