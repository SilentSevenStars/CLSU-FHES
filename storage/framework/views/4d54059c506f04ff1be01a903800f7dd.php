   ...
   <div class="h-full flex flex-col justify-between bg-[#0B712C] px-2 py-4 overflow-y-auto">
      ...
      <div class="flex-1">
         ...
         <div class="flex justify-center mb-6 mt-2">
            <a href="<?php echo e(route('nbc.dashboard')); ?>" class="flex items-center justify-center">
         ...
         <ul class="space-y-2 font-medium">
            <li>
               <a href="<?php echo e(route('nbc.dashboard')); ?>"
      ...
      <div class="mb-2 hidden sm:block relative">
        ...
        <div id="panelSidebarUserMenu" 
            ...
            <ul class="py-2 text-sm text-gray-700">
                <li><a href="<?php echo e(route('nbc.profile-view')); ?>" class="block px-4 py-2 hover:bg-gray-100">Settings</a></li>
            </ul>
            <div class="py-1">
...
</aside><?php /**PATH C:\xampp\htdocs\CLSU-FHES\resources\views/components/nav-nbc.blade.php ENDPATH**/ ?>