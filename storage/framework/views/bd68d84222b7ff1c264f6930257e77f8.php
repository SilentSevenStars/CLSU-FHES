                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <!-- Requirements -->
                                    <td class="px-6 py-4">
                                        <?php if(!empty($app->requirements_file)): ?>
                                            <a
                                    ...
                                    <!-- Interview Schedule -->
                                    <td class="px-6 py-4">
                                        <?php if(!empty($app->interview_schedule) && $app->interview_schedule['date']): ?>
                                    ...
                                    <!-- Evaluation Status -->
                                    <td class="px-6 py-4">
                                        <?php if(!empty($app->evaluation_status['status'])): ?>
                                            <?php if($app->evaluation_status['is_complete']): ?>
                                                <!-- Complete Status -->
                                            ...
                                            <?php else: ?>
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <?php if(isset($app->evaluation_status['completed_count'])): ?>
