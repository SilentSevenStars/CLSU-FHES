                            ...
                            <div class="p-1.5 min-w-full inline-block align-middle">
                                <div class="bg-gray-50 border border-gray-300 rounded-xl shadow-2xs overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        <!-- Create Button -->
                                        <div>
                                            <a href="<?php echo e(route('admin.position.create')); ?>" 
                                    ...
                                    <table class="min-w-full divide-y divide-gray-300">
                                        ...
                                        <tbody class="divide-y divide-gray-300 bg-gray-50">
                                            ...
                                            <tr class="bg-gray-50 hover:bg-gray-100">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-black"><?php echo e($position->start_date); ?></td>
                                                <td class="px-6 py-4 whitespace-nowrap text-black"><?php echo e($position->end_date); ?></td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <a href="<?php echo e(route('admin.position.edit', $position->id)); ?>"
...
</div><?php /**PATH C:\Users\admin\Documents\GitHub\Git Uploads\CLSU-FHES\resources\views/livewire/admin/position/position-index.blade.php ENDPATH**/ ?>