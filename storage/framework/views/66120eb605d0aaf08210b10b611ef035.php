        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="bg-white rounded-lg p-3 border border-gray-200">
                                    <!--[if BLOCK]><![endif]--><?php if($application->requirements_file): ?>
                ...
                <div class="bg-white border-2 border-indigo-200 rounded-lg p-6">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($isWithinApplicationPeriod): ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($status === 'approve' && !$isWithinApplicationPeriod): ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['interview_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['interview_room'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-600 text-sm"><?php echo e($message); ?></span>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-6 border-2 border-gray-200">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($application->status === 'approve' && $application->evaluation): ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($application->admin_notes): ?>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(in_array($application->status, ['approve', 'decline'])): ?>
...
</div><?php /**PATH C:\Users\admin\Documents\GitHub\Git Uploads\CLSU-FHES\resources\views/livewire/admin/applicant-show.blade.php ENDPATH**/ ?>