...
<?php if(request()->routeIs('assign.position')): ?>
<link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('image/clsu-logo-green.png')); ?>">
<link rel="shortcut icon" href="<?php echo e(asset('image/clsu-logo-green.png')); ?>">
<?php endif; ?>
...
<!-- Main content -->
<?php if(in_array(Auth::user()->role, ['applicant', 'admin', 'panel'])): ?>
...
<?php /**PATH C:\xampp\htdocs\CLSU-FHES\resources\views\layouts\app.blade.php ENDPATH**/ ?>