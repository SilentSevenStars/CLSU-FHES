   ...
   <div class="h-full flex flex-col justify-between bg-[#0B712C] px-2 py-4 overflow-y-auto">
      ...
      <div class="flex-1">
         ...
         <div class="flex justify-center mb-6 mt-2">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center justify-center">
               <img src="<?php echo e(asset('image/clsu-logo-green.png')); ?>" alt="CLSU Logo"
         ...
         <ul class="space-y-2 font-medium">
            <li>
               <a href="<?php echo e(route('admin.dashboard')); ?>"
                  ...
                  <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-[#0A6025] text-white' : 'text-white hover:bg-[#0A6025]'); ?>">
            ...
            <li>
               <a href="<?php echo e(route('admin.position')); ?>"
                  class="flex items-center p-3 rounded-lg
                  <?php echo e(request()->routeIs('admin.position') ? 'bg-[#0A6025] text-white' : 'text-white hover:bg-[#0A6025]'); ?>">
            ...
            <li>
               ...
               <ul x-show="applicantOpen" x-transition class="ml-8 mt-1 space-y-1 text-sm">
                  <li>
                     <a href="<?php echo e(route('admin.applicant')); ?>" class="block p-2 rounded hover:bg-[#0A6025] text-white">
                        Applicants
                     </a>
                  </li>
                  <li>
                     <a href="<?php echo e(route('admin.scheduled')); ?>" class="block p-2 rounded hover:bg-[#0A6025] text-white">
                        Scheduled Applicant
                     </a>
                  </li>
                  <li>
                     <a href="<?php echo e(route('admin.assign.position')); ?>"
                        class="block p-2 rounded hover:bg-[#0A6025] text-white">
                        Assign Position
                     </a>
                  </li>
                  <li>
                     <a href="<?php echo e(route('admin.applicant.archive')); ?>"
                        class="block p-2 rounded hover:bg-[#0A6025] text-white">
            ...
            <li>
               ...
               <ul x-show="screeningOpen" x-transition class="ml-8 mt-1 space-y-1 text-sm">
                  <li>
                     <a href="<?php echo e(route('admin.screening')); ?>" class="block p-2 rounded hover:bg-[#0A6025] text-white">
                        Screening
                     </a>
                  </li>
                  <li>
            ...
            <li>
               ...
               <ul x-show="nbcOpen" x-transition class="ml-8 mt-1 space-y-1 text-sm">
                  <li>
                     <a href="<?php echo e(route('admin.nbc')); ?>" class="block p-2 rounded hover:bg-[#0A6025] text-white">
                        NBC
                     </a>
                  </li>
                  <li>
            ...
            <li>
               ...
               <ul x-show="managementOpen" x-transition class="ml-8 mt-1 space-y-1 text-sm">
                  ...
                  <?php endif; ?>
                  <li>
                     <a href="<?php echo e(route('admin.user.archive.view')); ?>"
                        class="block p-2 rounded hover:bg-[#0A6025] text-white">
            ...
            <li>
               <a href="<?php echo e(route('admin.notifications')); ?>"
                  class="flex items-center p-3 rounded-lg
                  <?php echo e(request()->routeIs('admin.notifications') ? 'bg-[#0A6025] text-white' : 'text-white hover:bg-[#0A6025]'); ?>">
...
</aside><?php /**PATH C:\Users\admin\Documents\GitHub\Git Uploads\CLSU-FHES\resources\views/components/nav-admin.blade.php ENDPATH**/ ?>