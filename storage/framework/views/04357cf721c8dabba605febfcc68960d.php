<div class="min-h-screen bg-gray-50 py-8"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!--[if BLOCK]><![endif]--><?php if(!$nbcCommittee): ?>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $evaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($userAssignment && $userAssignment->status === 'complete'): ?>
...
</div><?php /**PATH C:\xampp\htdocs\CLSU-FHES\resources\views/livewire/nbc/dashboard.blade.php ENDPATH**/ ?>