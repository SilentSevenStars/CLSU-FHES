                                ...
                                <div class="bg-gray-50 border border-gray-300 rounded-xl shadow-2xs overflow-hidden">
                                    ...
                                    <table class="min-w-full divide-y divide-gray-300">
                                        ...
                                        <tbody class="divide-y divide-gray-300 bg-gray-50">
                                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $positionRanks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr class="bg-gray-50 hover:bg-gray-100">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-black">
                                                    <?php echo e($rank->created_at->format('M d, Y h:i A')); ?>

                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                    <button wire:click="edit(<?php echo e($rank->id); ?>)"
                                                        class="text-white bg-yellow-500 hover:bg-yellow-600 rounded-lg px-3 py-1 text-sm font-medium">
                                                        Edit
                                                    </button>
                                                    <button wire:click="confirmDelete(<?php echo e($rank->id); ?>)"
                                    ...
                                    <!-- Pagination -->
                                    <div class="p-4">
                                        <?php echo e($positionRanks->links()); ?>
            ...
            <div @click.away="$wire.closeModal()" class="bg-white rounded-lg shadow-xl max-w-md w-full">
                <div class="bg-green-600 px-6 py-4 rounded-t-lg">
                    <h3 class="text-xl font-bold text-white">
                        <?php echo e($editMode ? 'Edit' : 'Create'); ?> Position Rank
                    </h3>
                </div>
                    ...
                    <div class="p-6">
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   wire:model="name" 
                                   id="name"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-blue-500 <?php $__errorArgs = ['name'];
...
</div><?php /**PATH C:\Users\admin\Documents\GitHub\Git Uploads\CLSU-FHES\resources\views/livewire/admin/position-rank-manager.blade.php ENDPATH**/ ?>