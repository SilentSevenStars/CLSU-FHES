        ...
        <div class="w-full max-w-md">
            <div class="relative w-full min-h-[600px]" id="authContainer">
                <div class="absolute top-0 left-0 w-full transition-opacity duration-300 ease-in-out sign-up-form">
                    <form method="POST" action="<?php echo e(route('register')); ?>" class="w-full" x-data="registerForm()">
                        <?php echo csrf_field(); ?>
                        <!-- Title -->
                        <div class="mb-10">
...
<?php endif; ?>
    ...
    <script>
        function registerForm() {
            return {
                currentStep: 1,
                firstName: '<?php echo e(old("first_name")); ?>',
                middleName: '<?php echo e(old("middle_name")); ?>',
                lastName: '<?php echo e(old("last_name")); ?>',
                suffix: '<?php echo e(old("suffix")); ?>',
...
<?php endif; ?><?php /**PATH C:\Users\Owner\Desktop\projects\CLSU CAPS\resources\views/auth/register.blade.php ENDPATH**/ ?>