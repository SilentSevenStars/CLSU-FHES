<aside id="applicant-sidebar" 
   ...
   <div class="h-full flex flex-col justify-between bg-[#0B712C] px-2 py-4 overflow-y-auto">
      ...
      <!-- Close Button (Mobile) -->
      <button id="applicant-sidebar-close" 
         ...
         <div class="flex justify-center mb-6 mt-2">
            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center justify-center">
               <img src="<?php echo e(asset('image/clsu-logo-green.png')); ?>" 
                    alt="CLSU Logo" 
                    class="h-12 w-auto group-hover:h-28 transition-all duration-300">
            </a>
         </div>
         ...
         <ul class="space-y-2 font-medium">
            <li>
               <a href="<?php echo e(route('dashboard')); ?>"
                  ...
                  <?php echo e(request()->routeIs('dashboard') ? 'bg-[#0A6025] text-white' : 'text-white hover:bg-[#0A6025]'); ?>">
            ...
            <li>
               <a href="<?php echo e(route('apply-job')); ?>"
                  class="flex items-center p-3 rounded-lg
                  <?php echo e(request()->routeIs('apply-job') ? 'bg-[#0A6025] text-white' : 'text-white hover:bg-[#0A6025]'); ?>">
            ...
            <li>
               <a href="<?php echo e(route('notifications')); ?>"
                  class="flex items-center p-3 rounded-lg
                  <?php echo e(request()->routeIs('notifications') ? 'bg-[#0A6025] text-white' : 'text-white hover:bg-[#0A6025]'); ?>">
                  <i class="fa-solid fa-briefcase text-xl w-5 flex-shrink-0"></i>
                  <span class="ml-4 whitespace-nowrap 
                      block sm:hidden sm:group-hover:block
                      transition-all duration-300">
      ...
      <div class="mb-2 hidden sm:block relative">
        ...
        <div id="sidebarUserMenu" 
            ...
            <ul class="py-2 text-sm text-gray-700">
                <li><a href="<?php echo e(route('profile-view')); ?>" class="block px-4 py-2 hover:bg-gray-100">Settings</a></li>
            </ul>
            <div class="py-1">
...
<?php /**PATH C:\Users\admin\Documents\GitHub\Git Uploads\CLSU-FHES\resources\views/components/nav-applicant.blade.php ENDPATH**/ ?>