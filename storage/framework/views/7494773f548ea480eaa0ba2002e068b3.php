            ...
            <div class="px-6 py-4 flex flex-wrap items-center justify-between border-b border-gray-300 gap-3">
                ...
                <div class="min-w-[160px]">
                    <input
                        ...
                        class="mt-1 py-2 px-3 block w-full border-gray-300 rounded-lg text-sm
                               focus:border-[#1E7F3E] focus:ring-[#1E7F3E]"
...
</div><?php /**PATH C:\Users\admin\Documents\GitHub\Git Uploads\CLSU-FHES\resources\views/livewire/admin/screening.blade.php ENDPATH**/ ?>