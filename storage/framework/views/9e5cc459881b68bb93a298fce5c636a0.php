<div>
                                        ...
                                        <tbody class="divide-y divide-gray-300 bg-gray-50">
                                            ...
                                            <tr class="bg-gray-50 hover:bg-gray-100">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-black">
                                                    ...
                                                    <?php echo e($position->department->name ?? 'N/A'); ?>

                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-black">
                                                    <span class="px-2 py-1 rounded-full text-xs font-medium
                                                        <?php if($position->status === 'vacant'): ?> bg-amber-100 text-amber-800
                                                        <?php elseif($position->status === 'promotion'): ?> bg-emerald-100 text-emerald-800
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-black">
                                                    <?php echo e($position->start_date ? \Carbon\Carbon::parse($position->start_date)->format('M d, Y') : 'N/A'); ?>

                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-black">
                                                    <?php echo e($position->end_date ? \Carbon\Carbon::parse($position->end_date)->format('M d, Y') : 'N/A'); ?>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                    ...
                                                    <button wire:click="deleteConfirmed(<?php echo e($position->id); ?>)"
    ...
    <?php echo $__env->make('livewire.admin.modals.create-position', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>

    <?php if($showEditModal): ?>
    <?php echo $__env->make('livewire.admin.modals.edit-position', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\CLSU-FHES\resources\views\livewire\admin\position-manager.blade.php ENDPATH**/ ?>