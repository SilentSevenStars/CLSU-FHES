...
<?php if (\Illuminate\Support\Facades\Blade::check('role', 'applicant')): ?>
<button id="mobile-menu-toggle"
    ...
    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
        <path fill-rule="evenodd" clip-rule="evenodd"
            d="M2 4.75h14.5a.75.75 0 010 1.5H2.75a.75.75 0 01-.75-.75z
               M2 10h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z
               M2 15.25h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75z"/>
    </svg>
</button>
<?php endif; ?>
...
<?php if (\Illuminate\Support\Facades\Blade::check('role', ['panel', 'nbc'])): ?>
<button id="mobile-menu-toggle"
...
</div><?php /**PATH C:\Users\admin\Documents\GitHub\Git Uploads\CLSU-FHES\resources\views/components/mobile-view.blade.php ENDPATH**/ ?>