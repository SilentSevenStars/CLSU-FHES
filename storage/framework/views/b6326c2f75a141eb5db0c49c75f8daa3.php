...
unset($__errorArgs, $__bag); ?> rounded-lg focus:ring-2 focus:ring-[#0A6025]">
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['present_position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="text-red-500 text-sm mt-1 block"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-lg focus:ring-2 focus:ring-[#0A6025]">
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['other_involvement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="text-red-500 text-sm mt-1 block"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="pb-6">
                        ...
                        <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($requirements_file): ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['requirements_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</div><?php /**PATH C:\Users\admin\Documents\GitHub\Git Uploads\CLSU-FHES\resources\views/livewire/applicant/job-application.blade.php ENDPATH**/ ?>