...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('professional_developments', function (Blueprint $table) {
            ...
            $table->foreignId('creative_work_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('activity_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('recognition_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('award_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('outreach_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('licensure_id')->nullable()->constrained()->onDelete('cascade');
