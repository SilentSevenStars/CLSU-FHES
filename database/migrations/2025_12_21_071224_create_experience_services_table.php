...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('experience_services', function (Blueprint $table) {
            ...
            $table->decimal('q2_1_1', 8, 3)->nullable();
            $table->decimal('q2_1_2', 8, 3)->nullable();
            $table->decimal('q2_2_1', 8, 3)->nullable();
            $table->decimal('q2_3_1', 8, 3)->nullable();
            $table->decimal('q2_3_2', 8, 3)->nullable();
            $table->timestamps();
        });
    }
