...
<body>
    ...
    <div class="signature-section">
        <div class="signature-title">EVALUATION COMMITTEE</div>
        
        <div class="signature-row">
            <div class="signature-line"></div>
            <div class="signature-label">EFREN DELA CRUZ</div>
            <div style="font-size: 10px;">Evaluator</div>
        </div>

        <div class="signature-row">
            <div class="signature-line"></div>
            <div class="signature-label">MERCEDITA M. REYES</div>
            <div style="font-size: 10px;">Evaluator</div>
        </div>

        <div class="signature-row">
            <div class="signature-line"></div>
            <div class="signature-label">MA. ELIZABETH C. LEOVERAS</div>
            <div style="font-size: 10px;">Evaluator</div>
        </div>

        <!-- Right Side Approval -->
        <div class="right-signature">
            <div style="margin-bottom: 10px; font-size: 10px;">Approved:</div>
            <div class="signature-line" style="width: 300px;"></div>
            <div class="signature-label">JANET O. SATURNO</div>
            <div style="font-size: 10px;">CLSU NBC 461 Chairperson</div>
        </div>
    </div>
