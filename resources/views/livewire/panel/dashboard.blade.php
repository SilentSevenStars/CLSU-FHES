                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @forelse ($applications as $app)
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <div class="h-10 w-10 rounded-full bg-[#0A6025] flex items-center justify-center text-white font-semibold">
                                                        {{ strtoupper(substr($app->applicant->first_name, 0, 1) . substr($app->applicant->last_name, 0, 1)) }}
                                                    </div>
                                                </div>
                                                <div class="ml-4">
                                                    ...
                                                    <div class="text-sm text-gray-500">{{ $app->applicant->user->email }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <!-- Position -->
                                        <td class="px-6 py-4">
                                            <div class="text-sm font-semibold text-gray-900">{{ $app->position->position }}</div>
                                            <div class="text-sm text-gray-500">{{ $app->position->name }}</div>
                                        </td>
