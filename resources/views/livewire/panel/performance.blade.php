                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex justify-between items-center py-4 border-b">
                                ...
                                <div class="flex gap-12">
                                    ...
                                    <label class="flex items-center justify-center w-16">
                                        <input type="radio" wire:model="question1" value="{{ $value }}"
                            ...
                            <div class="flex justify-between items-center py-4 border-b">
                                ...
                                <div class="flex gap-12">
                                    @foreach(['VS', 'S', 'F', 'P', 'NI'] as $value)
                                    <label class="flex items-center justify-center w-16">
                                        <input type="radio" wire:model="question2" value="{{ $value }}"
                                            class="w-6 h-6 cursor-pointer">
                                    </label>
                                    @endforeach
                                </div>
                            ...
                            <div class="flex justify-between items-center py-4 border-b">
                                ...
                                <div class="flex gap-12">
                                    @foreach(['VS', 'S', 'F', 'P', 'NI'] as $value)
                                    <label class="flex items-center justify-center w-16">
                                        <input type="radio" wire:model="question3" value="{{ $value }}"
                                            class="w-6 h-6 cursor-pointer">
                                    </label>
                                    @endforeach
                                </div>
                            ...
                            <div class="flex justify-between items-center py-4 border-b">
                                ...
                                <div class="flex gap-12">
                                    @foreach(['VS', 'S', 'F', 'P', 'NI'] as $value)
                                    <label class="flex items-center justify-center w-16">
                                        <input type="radio" wire:model="question4" value="{{ $value }}"
                                            class="w-6 h-6 cursor-pointer">
                                    </label>
                                    @endforeach
                                </div>
                            ...
                            <div class="flex justify-between items-center py-4">
                                ...
                                <div class="flex gap-12">
                                    @foreach(['VS', 'S', 'F', 'P', 'NI'] as $value)
                                    <label class="flex items-center justify-center w-16">
                                        <input type="radio" wire:model="question5" value="{{ $value }}"
                                            class="w-6 h-6 cursor-pointer">
                                    </label>
                                    @endforeach
                                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex justify-between items-center py-4">
                                ...
                                <div class="flex gap-12">
                                    @foreach(['VS', 'S', 'F', 'P', 'NI'] as $value)
                                    <label class="flex items-center justify-center w-16">
                                        <input type="radio" wire:model="personalQuestion1" value="{{ $value }}"
                                            class="w-6 h-6 cursor-pointer">
                                    </label>
                                    @endforeach
                                </div>
