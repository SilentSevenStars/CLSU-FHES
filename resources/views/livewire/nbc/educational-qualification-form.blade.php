        ...
        <div class="mb-6 bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-blue-700 text-sm mt-0.5">
                    The <span class="font-semibold">Previous Points</span> column shows your saved score.
                    Enter only the <span class="font-semibold">new points to add</span> in the input column — they will be summed with your previous score on save.
                </p>
            </div>
        </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="border-l-4 border-blue-500 pl-4">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 mb-4 text-sm text-gray-700 space-y-1">
                            ...
                            <div class="pl-4">1.1.4 Diploma Course: (Above a bachelor's degree)</div>
                            <div class="pl-4">1.1.5 Bachelor's Degree</div>
                            <div class="pl-8">a. Four Years &nbsp; b. Exceeding four years</div>
                            <div class="pl-4">1.1.6 Special Courses (3-year / 2-year post secondary)</div>
                        </div>
                        <div class="grid grid-cols-12 gap-4 items-center">
                            <div class="col-span-8">
                                <label class="block text-sm font-medium text-gray-700">Section 1.1 Score (Q1_1)</label>
                            </div>
                            ...
                            <div class="col-span-2">
                                <input type="number" wire:model.live="new_q1_1" step="0.001" min="0" max="85"
                    ...
                    <div class="border-l-4 border-green-500 pl-4">
                        ...
                        <div class="grid grid-cols-12 gap-4 items-center">
                            <div class="col-span-8">
                                <label class="block text-sm font-medium text-gray-700">Section 1.2 Score (Q1_2)</label>
                            </div>
                            <div class="col-span-2">
                                <div class="px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg text-center font-semibold text-gray-700 text-sm">
                            ...
                            <div class="col-span-2">
                                <input type="number" wire:model.live="new_q1_2" step="0.001" min="0" max="85"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-center"
                                    placeholder="+0">
                            </div>
                        </div>
                    ...
                    <div class="border-l-4 border-purple-500 pl-4">
                        ...
                        <div class="grid grid-cols-12 gap-4 items-center">
                            <div class="col-span-8">
                                <label class="block text-sm font-medium text-gray-700">Section 1.3 Score (Q1_3)</label>
                            </div>
                            <div class="col-span-2">
                                <div class="px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg text-center font-semibold text-gray-700 text-sm">
