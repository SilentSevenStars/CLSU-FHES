...
<div class="border-l-4 border-green-500 pl-4 mb-6">
    ...
    <div class="mt-4 pt-4 border-t border-gray-300">
        <div class="grid grid-cols-12 gap-4 items-center">
            <div class="col-span-8"><label class="block text-base font-bold text-gray-900">Section 3.2.1 Subtotal (MAX 10)</label></div>
            <div class="col-span-4"><div class="px-3 py-2 bg-green-100 border border-green-300 rounded-lg text-center font-bold text-green-900">{{ number_format($this->subtotal321, 3) }}</div></div>
        </div>
    </div>
</div>
...
<div class="border-l-4 border-orange-500 pl-4 mb-6">
    ...
    <div class="mt-4 pt-4 border-t border-gray-300">
        <div class="grid grid-cols-12 gap-4 items-center">
            <div class="col-span-8"><label class="block text-base font-bold text-gray-900">Section 3.2.2 Subtotal (MAX 20)</label></div>
            <div class="col-span-4"><div class="px-3 py-2 bg-orange-100 border border-orange-300 rounded-lg text-center font-bold text-orange-900">{{ number_format($this->subtotal322, 3) }}</div></div>
        </div>
    </div>
</div>