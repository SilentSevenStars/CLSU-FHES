            ...
            <div class="space-y-3 pl-4">
                    ...
                    @if($isVerifier)
                        <div class="col-span-2">
                            <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                                {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_1_1_a'] ?? 0), 2) : '—' }}
                            </div>
                        </div>
                    @endif
                    <div class="col-span-2">
                ...
                <div class="grid grid-cols-12 gap-4 items-center">
                    ...
                    @if($isVerifier)
                        <div class="col-span-2">
                            <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                                {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_1_1_b'] ?? 0), 2) : '—' }}
                            </div>
                        </div>
                    @endif
                    <div class="col-span-2">
                ...
                <div class="grid grid-cols-12 gap-4 items-center">
                    ...
                    @if($isVerifier)
                        <div class="col-span-2">
                            <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                                {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_1_1_c'] ?? 0), 2) : '—' }}
                            </div>
                        </div>
                    @endif
                    <div class="col-span-2">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="grid grid-cols-12 gap-4 items-center">
                ...
                @if($isVerifier)
                    <div class="col-span-2">
                        <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                            {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_1_2'] ?? 0), 2) : '—' }}
                        </div>
                    </div>
                @endif
                <div class="col-span-2">
            ...
            <div class="space-y-3 pl-4">
                <div class="grid grid-cols-12 gap-4 items-center">
                    ...
                    @if($isVerifier)
                        <div class="col-span-2">
                            <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                                {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_1_3_a'] ?? 0), 2) : '—' }}
                            </div>
                        </div>
                    @endif
                    <div class="col-span-2">
                ...
                <div class="grid grid-cols-12 gap-4 items-center">
                    ...
                    @if($isVerifier)
                        <div class="col-span-2">
                            <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                                {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_1_3_b'] ?? 0), 2) : '—' }}
                            </div>
                        </div>
                    @endif
                    <div class="col-span-2">
                ...
                <div class="grid grid-cols-12 gap-4 items-center">
                    ...
                    @if($isVerifier)
                        <div class="col-span-2">
                            <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                                {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_1_3_c'] ?? 0), 2) : '—' }}
                            </div>
                        </div>
                    @endif
                    <div class="col-span-2">
    ...
    <div class="mt-4 pt-4 border-t border-gray-300">
        <div class="grid grid-cols-12 gap-4 items-center">
            ...
            @if($isVerifier)
                @php
                    $evalSub321 = min(
                        collect(['rs_3_2_1_1_a','rs_3_2_1_1_b','rs_3_2_1_1_c','rs_3_2_1_2',
                ...
                <div class="col-span-2">
                    ...
                    <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-bold text-blue-700">
                        {{ $evaluatorScoresExist ? number_format($evalSub321, 2) : '—' }}
                    </div>
                </div>
                <div class="col-span-2">
                    ...
                    <div class="px-3 py-2 bg-green-50 border border-green-400 rounded-lg text-center font-bold text-green-800">
                        {{ number_format($this->subtotal321, 2) }}
                    </div>
                </div>
            @else
                <div class="col-span-2">
            ...
            <div class="space-y-3 pl-4">
                <div class="grid grid-cols-12 gap-4 items-center">
                    ...
                    @if($isVerifier)
                        <div class="col-span-2">
                            <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                                {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_2_1_a'] ?? 0), 2) : '—' }}
                            </div>
                        </div>
                    @endif
                    <div class="col-span-2">
                ...
                <div class="grid grid-cols-12 gap-4 items-center">
                    ...
                    @if($isVerifier)
                        <div class="col-span-2">
                            <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                                {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_2_1_b'] ?? 0), 2) : '—' }}
                            </div>
                        </div>
                    @endif
                    <div class="col-span-2">
                ...
                <div class="grid grid-cols-12 gap-4 items-center">
                    ...
                    @if($isVerifier)
                        <div class="col-span-2">
                            <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                                {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_2_1_c'] ?? 0), 2) : '—' }}
                            </div>
                        </div>
                    @endif
                    <div class="col-span-2">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="grid grid-cols-12 gap-4 items-center">
                ...
                @if($isVerifier)
                    <div class="col-span-2">
                        <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                            {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_2_2'] ?? 0), 2) : '—' }}
                        </div>
                    </div>
                @endif
                <div class="col-span-2">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="grid grid-cols-12 gap-4 items-center">
                ...
                @if($isVerifier)
                    <div class="col-span-2">
                        <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                            {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_2_3'] ?? 0), 2) : '—' }}
                        </div>
                    </div>
                @endif
                <div class="col-span-2">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="grid grid-cols-12 gap-4 items-center">
                ...
                @if($isVerifier)
                    <div class="col-span-2">
                        <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                            {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_2_4'] ?? 0), 2) : '—' }}
                        </div>
                    </div>
                @endif
                <div class="col-span-2">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="grid grid-cols-12 gap-4 items-center">
                ...
                @if($isVerifier)
                    <div class="col-span-2">
                        <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                            {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_2_5'] ?? 0), 2) : '—' }}
                        </div>
                    </div>
                @endif
                <div class="col-span-2">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="grid grid-cols-12 gap-4 items-center">
                ...
                @if($isVerifier)
                    <div class="col-span-2">
                        <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                            {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_2_6'] ?? 0), 2) : '—' }}
                        </div>
                    </div>
                @endif
                <div class="col-span-2">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="grid grid-cols-12 gap-4 items-center">
                ...
                @if($isVerifier)
                    <div class="col-span-2">
                        <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-semibold text-blue-700 text-sm">
                            {{ $evaluatorScoresExist ? number_format((float)($evaluatorScores['rs_3_2_2_7'] ?? 0), 2) : '—' }}
                        </div>
                    </div>
                @endif
                <div class="col-span-2">
    ...
    <div class="mt-4 pt-4 border-t border-gray-300">
        <div class="grid grid-cols-12 gap-4 items-center">
            ...
            @if($isVerifier)
                @php
                    $evalSub322 = min(
                        collect(['rs_3_2_2_1_a','rs_3_2_2_1_b','rs_3_2_2_1_c',
                                 'rs_3_2_2_2','rs_3_2_2_3','rs_3_2_2_4',
                                 'rs_3_2_2_5','rs_3_2_2_6','rs_3_2_2_7'])
                            ->sum(fn($f) => (float)($evaluatorScores[$f] ?? 0)),
                        20
                    );
                @endphp
                <div class="col-span-2">
                    <div class="text-xs text-center text-blue-600 mb-1 font-medium">Evaluator</div>
                    <div class="px-3 py-2 bg-blue-50 border border-blue-300 rounded-lg text-center font-bold text-blue-700">
                        {{ $evaluatorScoresExist ? number_format($evalSub322, 2) : '—' }}
                    </div>
                </div>
                <div class="col-span-2">
                    <div class="text-xs text-center text-green-700 mb-1 font-medium">Yours</div>
                    <div class="px-3 py-2 bg-green-50 border border-green-400 rounded-lg text-center font-bold text-green-800">
                        {{ number_format($this->subtotal322, 2) }}
                    </div>
                </div>
            @else
                <div class="col-span-2">
