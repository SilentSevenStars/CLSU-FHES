<div class="flex-1 bg-gradient-to-br from-slate-50 via-green-50 to-emerald-50 p-6 overflow-auto min-h-screen">
    <div class="max-w-7xl mx-auto">
        ...
        <div x-data="{ show: @entangle('showAlertModal') }" x-show="show" x-cloak
            class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="alert-modal-title" role="dialog"
            aria-modal="true">
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full sm:mx-0 sm:h-10 sm:w-10"
                                ...
                                <svg x-show="'{{ $alertType }}' === 'success'" class="h-6 w-6 text-green-600"
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                <h3 class="text-lg leading-6 font-medium text-gray-900" id="alert-modal-title">
                                    <span x-show="'{{ $alertType }}' === 'success'"
                                        class="text-green-600">Success!</span>
                            ...
                            <div class="bg-gray-50 border border-gray-300 rounded-xl shadow-2xs overflow-hidden">
                                ...
                                <table class="min-w-full divide-y divide-gray-300">
                                    <thead class="bg-gray-200">
                                        <tr>
                                            <th scope="col" class="px-6 py-3 text-start"><span
                                                    class="text-xs font-semibold uppercase text-black">Applicant
                                                    Name</span></th>
                                            <th scope="col" class="px-6 py-3 text-start"><span
                                                    class="text-xs font-semibold uppercase text-black">Current
                                                    Position</span></th>
                                            <th scope="col" class="px-6 py-3 text-start"><span
                                                    class="text-xs font-semibold uppercase text-black">Applied
                                                    Position</span></th>
                                            <th scope="col" class="px-6 py-3 text-start"><span
                                                    class="text-xs font-semibold uppercase text-black">Evaluation
                                                    Status</span></th>
                                            <th scope="col" class="px-6 py-3 text-start"><span
                                                    class="text-xs font-semibold uppercase text-black">Actions</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="divide-y divide-gray-300 bg-gray-50">
                                        ...
                                        <tr class="bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">{{ $applicant->user->name
                                                    }}</div>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @php
                                                $hasPanelComplete =
                                                $application->evaluation->panelAssignments()->where('status',
                                                'complete')->exists();
                                                $hasNbcComplete =
                                                $application->evaluation->nbcAssignments()->where('status',
                                                'complete')->exists();
                                                $isComplete = $hasPanelComplete || $hasNbcComplete;
                                                @endphp
                                                @if($isComplete)
                                                <span
                                                    class="px-3 py-1.5 inline-flex text-sm leading-5 font-semibold rounded-full bg-green-100 text-green-800">✓
                                                    Complete</span>
                                                @else
                                                <span
                                                    class="px-3 py-1.5 inline-flex text-sm leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-600">Pending</span>
                                                @endif
                                            </td>
                ...
                <div x-show="show" x-transition:enter="ease-out duration-300"
                        ...
                        <div class="space-y-4">
                            <div class="relative" x-data="{ open: @entangle('showDropdown') }">
                                ...
                                <div x-show="open" x-cloak
                                    ...
                                    @endforeach
                                    @else
                                    <div class="px-4 py-3 text-sm text-gray-500 text-center">No matching names found
                                    </div>
                                    @endif
                                </div>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Filter by Applied
                                    Position</label>
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-2">
                        ...
                        <button type="button" wire:click="clearFilters"
                            class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none sm:mt-0 sm:w-auto sm:text-sm">Clear
                            All</button>
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-2 space-y-4">
                                    <p class="text-sm text-gray-500">Are you sure you want to assign the following
                                        position?</p>
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4 space-y-2">
                                        ...
                                        <div class="flex justify-between text-sm">
                                            ...
                                            <span class="text-gray-900">{{ $selectedApplicant->position ?? 'None'
                                                }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border border-green-200 rounded-lg overflow-hidden">
                                        <div class="bg-[#1E7F3E] px-4 py-2">
                                            ...
                                            <p class="text-green-100 text-xs">Pre-filled from the job application —
                                                please confirm these are correct.</p>
                                        </div>
                                        <div class="p-4 space-y-3 bg-green-50">
                                            <!-- Position -->
                                            <div>
                                                <label
                                                    class="block text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">New
                                                    Position</label>
                                            ...
                                            <div>
                                                <label
                                                    class="block text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">College</label>
                                            ...
                                            <!-- Department (filtered by college) -->
                                            <div>
                                                <label
                                                    class="block text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">Department</label>
                                                ...
                                                @if(!$confirmCollegeId)
                                                <p class="text-xs text-gray-400 mt-1">Select a college first to filter
                                                    departments.</p>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                                            ...
                                            <span class="font-normal text-gray-500">(sent via email &amp;
                                                notification)</span>
                                        </label>
                                        <textarea wire:model.defer="admin_message" rows="8"
                                            ...
                                            placeholder="Write a message to the applicant. This will be sent via email and the notification system."></textarea>
                                        <p class="mt-1 text-xs text-gray-500">This message will be sent to the
                                            applicant's email and appear in their notification inbox.</p>
                                    </div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                                            Attachments
                                            <span class="font-normal text-gray-500">(optional — PDF, Word, images, etc.
                                                Max 10 MB each)</span>
                                        </label>
                                        ...
                                        <label for="assign-file-upload"
                                            ...
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                <svg class="w-8 h-8 mb-2 text-[#1E7F3E]" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                                ...
                                                <p class="text-sm text-gray-600"><span
                                                        class="font-semibold text-[#1E7F3E]">Click to upload</span> or
                                                    drag and drop</p>
                                        ...
                                        <div wire:loading wire:target="attachments"
                                            class="mt-2 flex items-center gap-2 text-sm text-green-700">
                                        ...
                                        @error('attachments.*') <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
                                        ...
                                        <ul class="mt-3 space-y-2">
                                            ...
                                            <li
                                                class="flex items-center justify-between bg-white border border-green-200 rounded-lg px-3 py-2">
                                                <div class="flex items-center gap-2 min-w-0">
                                                    <div
                                                        class="w-8 h-8 bg-[#1E7F3E] rounded flex items-center justify-center flex-shrink-0">
                                                        <span class="text-white text-xs font-bold">{{
                                                            strtoupper(pathinfo($file->getClientOriginalName(),
                                    ...
                                    <p class="text-xs text-gray-500">* This will mark the applicant as hired and send
                                        the notification above</p>
                                </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-2 space-y-4">
                                    <p class="text-sm text-gray-500">Are you sure you want to archive this job
                                        application?</p>
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4 space-y-2">
                                        <div class="flex justify-between text-sm">
                                            ...
                                            <span class="text-gray-900">{{
                                                $selectedJobApplication->applicant->user->name }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border border-yellow-200 rounded-lg overflow-hidden">
                                        <div class="bg-yellow-600 px-4 py-2">
                                            <p class="text-white text-sm font-semibold">Verify Application Details</p>
                                            <p class="text-yellow-100 text-xs">Pre-filled from the job application —
                                                please confirm.</p>
                                        </div>
                                        <div class="p-4 space-y-3 bg-yellow-50">
                                            ...
                                            <div>
                                                <label
                                                    class="block text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">Position</label>
                                                <select wire:model="archivePositionId"
                                                    class="w-full px-3 py-2 border border-yellow-300 rounded-lg text-sm focus:ring-2 focus:ring-yellow-500 focus:border-transparent bg-white">
                                                    @foreach(\App\Models\Position::orderBy('name')->get() as $pos)
                                                    <option value="{{ $pos->id }}">{{ $pos->name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div>
                                                <label
                                                    class="block text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">College</label>
                                                <select wire:model.live="archiveCollegeId"
                                                    class="w-full px-3 py-2 border border-yellow-300 rounded-lg text-sm focus:ring-2 focus:ring-yellow-500 focus:border-transparent bg-white">
                                                    <option value="">— No college —</option>
                                                    @foreach($colleges as $college)
                                                    <option value="{{ $college->id }}">{{ $college->name }}</option>
                                            ...
                                            <div>
                                                <label
                                                    class="block text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">Department</label>
                                                <select wire:model="archiveDepartmentId"
                                                    class="w-full px-3 py-2 border border-yellow-300 rounded-lg text-sm focus:ring-2 focus:ring-yellow-500 focus:border-transparent bg-white"
                                                    {{ !$archiveCollegeId ? 'disabled' : '' }}>
                                                    <option value="">— No department —</option>
                                                    @foreach($this->departmentsForArchive as $dept)
                                                    <option value="{{ $dept->id }}">{{ $dept->name }}</option>
                                                    @endforeach
                                                </select>
                                                @if(!$archiveCollegeId)
                                    ...
                                    <div>
                                        ...
                                        <textarea wire:model.defer="archive_message" rows="8"
                                            class="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-700 focus:ring-2 focus:ring-[#1E7F3E] focus:border-transparent"
                                            placeholder="Write a message to the applicant. This will be sent via email and the notification system."></textarea>
                                    </div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                                            Attachments
                                            <span class="font-normal text-gray-500">(optional — Max 10 MB each)</span>
                                        </label>

                                        <label for="archive-file-upload"
                                            class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-yellow-300 rounded-lg cursor-pointer bg-yellow-50 hover:bg-yellow-100 transition-colors duration-200">
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                <svg class="w-8 h-8 mb-2 text-yellow-600" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                                        d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12">
                                                ...
                                                <p class="text-sm text-gray-600"><span
                                                        class="font-semibold text-yellow-700">Click to upload</span> or
                                                    drag and drop</p>
                                                <p class="text-xs text-gray-400 mt-1">Multiple files allowed</p>
                                            </div>
                                        ...
                                        <div wire:loading wire:target="archiveAttachments"
                                            class="mt-2 flex items-center gap-2 text-sm text-yellow-700">
                                            <svg class="animate-spin h-4 w-4" fill="none" viewBox="0 0 24 24">
                                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                                    stroke-width="4"></circle>
                                                <path class="opacity-75" fill="currentColor"
                                        ...
                                        @error('archiveAttachments.*') <p class="text-xs text-red-500 mt-1">{{ $message
                                            }}</p> @enderror
                                        ...
                                        <ul class="mt-3 space-y-2">
                                            ...
                                            <li
                                                class="flex items-center justify-between bg-white border border-yellow-200 rounded-lg px-3 py-2">
                                                <div class="flex items-center gap-2 min-w-0">
                                                    <div
                                                        class="w-8 h-8 bg-yellow-600 rounded flex items-center justify-center flex-shrink-0">
                                                        <span class="text-white text-xs font-bold">{{
                                                            strtoupper(pathinfo($file->getClientOriginalName(),
                                                            PATHINFO_EXTENSION)) }}</span>
                                                    </div>
                                    ...
                                    <p class="text-xs text-gray-500">* Archived applications will not be visible in the
                                        active list</p>
                                </div>
                                @endif
                            </div>
