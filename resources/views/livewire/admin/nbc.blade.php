<div>
    <div class="flex-1 bg-gradient-to-br from-slate-50 via-green-50 to-emerald-50 p-6 overflow-auto min-h-screen">
        <div class="max-w-7xl mx-auto">
            ...
            {{-- Page Header --}}
            <div class="mb-8">
                <h1 class="text-4xl font-extrabold text-[#0a6025] mb-2">NBC Evaluation</h1>
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <button
                            ...
                            class="ml-auto px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium flex items-center gap-2 shadow-lg hover:shadow-xl transition-all duration-300 disabled:bg-gray-400 disabled:cursor-not-allowed"
                            ...
                            <div class="overflow-x-auto rounded-lg border border-gray-200 shadow-sm">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-[#0a6025]">
                                        <tr>
                                            <th rowspan="2" class="px-6 py-3 text-left text-xs font-semibold text-white uppercase border-r border-white/20">
                                                Major Components
                                            </th>
                                            <th rowspan="2" class="px-6 py-3 text-center text-xs font-semibold text-white uppercase border-r border-white/20">
                                                Maximum Points
                                            </th>
                                            <th class="px-6 py-2 text-center text-xs font-semibold text-white uppercase border-r border-white/20">
                                                Previous Points
                                            </th>
                                            <th class="px-6 py-2 text-center text-xs font-semibold text-white uppercase border-r border-white/20">
                                                Additional Points
                                        ...
                                        <tr>
                                            <th class="px-6 py-1 text-center text-xs font-semibold text-white uppercase border-r border-white/20">
                                                Points as of
                                            </th>
                                            <th class="px-6 py-1 text-center text-xs font-semibold text-white uppercase border-r border-white/20">
                                                Points as of
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($nbcData as $data)
                                            ...
                                            <tr class="bg-gray-100 font-bold">
                                                ...
                                                <td class="px-6 py-3 text-sm text-center border-r border-gray-200">200</td>
                            ...
                            <div class="mt-4 p-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-lg border border-emerald-200 shadow-sm">
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-700">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="font-semibold text-gray-900">Evaluation Date:</span>
    ...
    {{-- Search Modal --}}
    @if($showSearchModal)
    <div x-data="{ show: @entangle('showSearchModal') }"
         x-show="show"
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            {{-- Backdrop --}}
            <div @click="$wire.closeSearchModal()"
                    ...
                    <div class="px-6 py-5 space-y-5">
                        ...
                        <div x-data="{ open: false }" @click.outside="open = false">
                            ...
                            <div class="relative">
                                ...
                                {{-- Dropdown --}}
                                <div x-show="open && {{ count($searchResults) > 0 ? 'true' : 'false' }}"
                                     class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-auto">
                                    @forelse($searchResults as $result)
                                        <div wire:click="selectApplicant({{ $result['id'] }}, '{{ addslashes($result['full_name']) }}')"
                                             @click="open = false"
                        ...
                        <div>
                            ...
                            <select wire:model.live="tempSelectedPosition"
                        ...
                        <div>
                            ...
                            <select wire:model="tempSelectedInterviewDate"
    ...
    {{-- JS: open the rendered HTML in a new tab for printing — same as Screening component --}}
    <script>
