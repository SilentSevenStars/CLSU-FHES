                    ...
                    <div class="bg-white px-6 pt-5 pb-4">
                        <div class="mb-4">
                            ...
                            <select
                                ...
                                id="college_id"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('college_id') border-red-500 @enderror"
                            >
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                wire:model="name"
                                id="name"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('name') border-red-500 @enderror"
