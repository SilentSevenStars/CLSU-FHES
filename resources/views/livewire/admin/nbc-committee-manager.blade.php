                                            ...
                                            <tr class="bg-gray-50 hover:bg-gray-100">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                    <div class="flex items-center justify-center gap-2">
                                                        ...
                                                        <button
                                                            wire:click="openDeleteModal({{ $committee->id }})"
                                    ...
                                    <div class="p-4 bg-white border-t border-gray-300 flex flex-col sm:flex-row items-center justify-between gap-3">
                                        <span class="text-xs text-gray-500">
                                            @if ($committees->total() > 0)
                                                Showing {{ $committees->firstItem() }} to {{ $committees->lastItem() }} of {{ $committees->total() }} member{{ $committees->total() !== 1 ? 's' : '' }}
                                            @else
                                                No members found
                                            @endif
                                        </span>
