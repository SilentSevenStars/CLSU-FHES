                                        ...
                                        <tr class="bg-gray-50 hover:bg-gray-100">
                                            <td class="size-px whitespace-nowrap align-top">
                                                <div class="text-sm font-semibold text-black">
                                                    {{ $committees->firstItem() ? $committees->firstItem() + $loop->index : $loop->iteration }}
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap align-top">
                                                <div class="text-sm font-semibold text-black">{{ $committee->user->name }}</div>
                                            </td>
                                            <td class="size-px whitespace-nowrap align-top">
                                                <div class="text-sm font-medium text-black">{{ $committee->user->email }}</div>
                                            </td>
                                            <td class="size-px whitespace-nowrap align-top">
                                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                    {{ $committee->position === 'evaluator' ? 'bg-blue-100 text-blue-800' : 'bg-emerald-100 text-emerald-800' }}">
                                                    {{ ucfirst($committee->position) }}
                                                </span>
                                            </td>
                                            <td class="size-px whitespace-nowrap align-top">
                                                <div class="text-sm font-medium text-black">
                                                    {{ $committee->created_at->format('M j, Y') }}
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap align-top">
                    ...
                    <div class="px-6 py-5 space-y-5">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                wire:model="name"
                                id="name"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0a6025] focus:border-transparent @error('name') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                wire:model="email"
                                id="email"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0a6025] focus:border-transparent @error('email') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                wire:model="password"
                                id="password"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0a6025] focus:border-transparent @error('password') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <select 
                                wire:model="position"
                                id="position"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0a6025] focus:border-transparent @error('position') border-red-500 @enderror">
