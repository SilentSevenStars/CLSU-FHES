        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden">
                ...
                <div class="bg-[#1E7F3E] p-6 flex justify-between items-center">
                    ...
                    <select wire:model.live="perPage" class="bg-white/90 rounded-lg px-4 py-2 text-sm">
                ...
                <div class="p-6 overflow-x-auto">
                    <div class="flex justify-between mb-4 gap-4 flex-wrap">
                        <input type="text" wire:model.live.debounce.300ms="search"
                            class="w-full md:w-1/3 border-gray-300 rounded-lg" placeholder="Search applicant...">

                        <span class="text-sm bg-orange-100 border border-orange-300 px-4 py-2 rounded-lg">
                            {{ $archivedApplicants->total() }} Archived Applicant{{ $archivedApplicants->total() !== 1 ?
                            's' : '' }}
                        </span>
                    </div>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Are you sure you want to restore this applicant? They will appear in the active
                                    applicants list and can be processed again.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white px-6 pt-5 pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Are you sure you want to <span class="font-semibold text-red-600">permanently
                                        delete</span> this applicant? This action cannot be undone and all data will be
                                    lost.
                                </p>
                                <div class="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <p class="text-xs text-red-800 font-medium">
                                        ⚠️ Warning: This is permanent. Consider restoring the applicant if you might
                                        need their data later.
                                    </p>
                                </div>
                            </div>
                        </div>
