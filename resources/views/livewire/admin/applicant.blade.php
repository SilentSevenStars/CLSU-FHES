            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border-l-4 border-amber-500 transform hover:-translate-y-1 animate-slideInLeft"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm font-semibold uppercase tracking-wide">Pending This Month</p>
                ...
                <div class="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border-l-4 border-emerald-500 transform hover:-translate-y-1 animate-slideInLeft"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm font-semibold uppercase tracking-wide">Approved This Month</p>
                            <h3 class="text-3xl font-bold text-gray-800 mt-2 transition-all duration-300">
                                {{ $approvedCount }}
                            </h3>
                ...
                <div class="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border-l-4 border-red-500 transform hover:-translate-y-1 animate-slideInLeft"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm font-semibold uppercase tracking-wide">Declined This Month</p>
                            <h3 class="text-3xl font-bold text-gray-800 mt-2 transition-all duration-300">
                                {{ $declinedCount }}
                            </h3>
                            <p class="text-xs text-gray-400 mt-1">Declined</p>
                        </div>
                        <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-2xl p-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                ...
                <div class="bg-[#0a6025] p-6">
                    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <!-- Department Filter (dynamic, disabled if no college selected) -->
                            ...
                            <!-- Position Filter (always enabled, free selection) -->
                                    ...
                                    <table class="min-w-full divide-y divide-gray-300">
                                        <thead class="bg-gray-200">
                                            <tr>
                                                ...
                                                <th scope="col" class="px-6 py-3 text-start">
                                                    <span class="text-xs font-semibold uppercase text-black">Date Applied</span>
                                                </th>
                                                <th scope="col" class="px-6 py-3 text-start">
                                        ...
                                        <tbody class="divide-y divide-gray-300 bg-gray-50">
                                            ...
                                            <tr>
                                                <td colspan="8" class="px-6 py-12 text-center">
                                                    ...
                                                    <p class="text-black text-lg font-medium">No applicant applications found</p>
                                                    <p class="text-gray-600 text-sm mt-1">Applications will appear here once submitted</p>
                                                </td>
                                            </tr>
                                            @endforelse
                                        </tbody>
