            ...
            <div class="mb-8 bg-white rounded-xl shadow-md p-6">
                ...
                <div class="flex items-center gap-0">
                    ...
                    <div class="flex items-center {{ $stepNum < $totalSteps ? 'flex-1' : '' }}">
                        ...
                        @endif
                            ...
                            <div class="w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all duration-300
                                ...
                                <svg class="w-4 h-4 {{ $stepNum === $currentStep ? 'text-[#0A6025]' : 'text-gray-400' }}"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $stepData['icon'] }}" />
                                </svg>
                                @endif
                            </div>
                            <span class="mt-1 text-xs font-medium {{ $stepNum === $currentStep ? 'text-[#0A6025]' : ($stepNum < $currentStep ? 'text-gray-600' : 'text-gray-400') }} hidden sm:block">
                                {{ $stepData['label'] }}
                            </span>
                        ...
                        <div class="flex-1 h-0.5 mx-2 mt-[-16px] sm:mt-[-10px] transition-all duration-500
                ...
                <form wire:submit.prevent="confirmSubmission" x-data
                    ...
                    <div class="animate-fadeIn space-y-6">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-0.5">You must read and accept the terms below before proceeding</p>
                            </div>
                        </div>

                        <div class="bg-gray-50 border border-gray-200 rounded-xl p-6 max-h-72 overflow-y-auto text-sm text-gray-700 space-y-4 leading-relaxed">
                    ...
                    <div class="animate-fadeIn">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Suffix <span class="text-gray-400 font-normal">(Optional)</span></label>
                    ...
                    <div class="animate-fadeIn">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-0.5">Share your professional background and qualifications</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">Leave blank if currently unemployed or not applicable.</p>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    Count your <strong>cumulative years</strong> across all positions held — present and past combined.
                                </p>
                    ...
                    <div class="animate-fadeIn space-y-8">
                        ...
                        <div>
                            ...
                            <div class="mb-5 bg-amber-50 border border-amber-200 rounded-xl p-5">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1 text-sm text-amber-800">
                                        <p class="font-bold text-amber-900 mb-2">📄 Please merge all your documents into one PDF File:</p>
                                        <ol class="list-decimal list-inside space-y-1 text-amber-800">
                                            <li>Application letter addressed to <strong>Dr. Evaristo A. Abella, University President</strong></li>
                                            ...
                                            <li>Other credentials (Journals, Publications, Speakership in Conferences, etc.)</li>
                                            <li>Applicants for <strong>Instructor I to Assistant Professor I</strong> positions shall only submit an E-copy of their credentials</li>
                                        </ol>
                                        ...
                                        <div class="mt-3 pt-3 border-t border-amber-300">
                                            ...
                                            <ol class="list-decimal list-inside space-y-1 text-amber-800" start="7">
                                                <li>For <strong>Instructor III, Assistant Professor III to Associate Professor IV</strong> Positions — One (1) Original and one (1) photocopy of credentials for NBC evaluation <em>(hard copies)</em></li>
                                                <li>
                                                    For <strong>Professorial Positions</strong> — One (1) Original and four (4) photocopy of credentials for NBC en banc evaluation <em>(hard copies)</em>
                                                    <ul class="list-none pl-4 mt-0.5">
                                                        <li class="text-amber-700 italic">— If NBC documents have been previously evaluated, submit only the 5 copies of your additional credentials.</li>
                                                    </ul>
                                                </li>
                                            </ol>
                                        </div>
                            ...
                            {{-- ═══ UPLOAD ZONE — wire:ignore prevents Livewire from morphing Alpine state ═══ --}}
                            <div wire:ignore
                                x-data="{
                                    isDragging: false,
                                    isUploading: false,
                                ...
                                <label
                                    ...
                                    <div class="text-center">
                                        <svg x-show="!isUploading" class="mx-auto h-14 w-14 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 48 48">
                                            <path stroke-linecap="round"
                                                d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02"
                                                stroke-width="2" />
                                        </svg>
                                        <div x-show="isUploading" class="mx-auto">
                                            <svg class="animate-spin h-14 w-14 text-[#0A6025] mx-auto" fill="none" viewBox="0 0 24 24">
                                        ...
                                        <p class="text-xs text-gray-500 mt-1" x-show="!isUploading">PDF only — MAX. 100MB</p>
                                    </div>
                                    <input
                                        type="file"
                                        wire:model="requirements_file"
                                        accept="application/pdf"
                                        class="hidden"
                                        x-ref="fileInput"
                                        @change="isUploading = true">
                                </label>
                            </div>
                            {{-- ═══ END wire:ignore zone ═══ --}}

                            {{-- File preview, loading, and errors are OUTSIDE wire:ignore so Livewire can update them --}}
