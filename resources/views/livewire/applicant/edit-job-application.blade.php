        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8 bg-white rounded-xl shadow-md p-6">
                <div class="flex items-center justify-between mb-4">
                    <h1 class="text-2xl font-extrabold text-gray-800">Edit Job Application</h1>
                ...
                <div class="animate-fadeIn">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-0.5">Update your basic personal details</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-0.5">Leave empty to keep your current uploaded file
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <svg class="w-8 h-8 text-blue-500 flex-shrink-0" fill="currentColor"
                                        viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                    ...
                                    <div>
                                        <span class="text-sm font-semibold text-blue-800">Current file on record
                                            (encrypted)</span>
                                        <p class="text-xs text-blue-600 mt-0.5">Upload a new PDF below to replace this
                                            file</p>
                                    </div>
                                </div>
                                <button type="button" wire:click="$dispatch('open-pdf-viewer')"
                                    class="inline-flex items-center px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors gap-1.5">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-5">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-0.5">Please read and accept before updating</p>
                            </div>
                        </div>
            ...
            <div class="flex-1 overflow-hidden rounded-b-lg">
                <div x-show="loading" class="flex flex-col items-center justify-center h-full gap-4">
                    <svg class="animate-spin h-12 w-12 text-blue-600" fill="none" viewBox="0 0 24 24">
                        ...
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V8l-4 4 4 4V8a8 8 0 11-8 8z">
                        </path>
                    </svg>
