            ...
            <div class="p-6">
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="text-base text-gray-900">{{ $fullName }}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="text-base text-gray-900">{{ $applicant->phone_number ?: 'Not provided' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-base text-gray-900">{{ $fullAddress ?: 'No address provided' }}</p>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base text-gray-900">{{ $applicant->province ?: 'N/A' }}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">City/Municipality</label>
                                        <p class="text-base text-gray-900">{{ $applicant->city ?: 'N/A' }}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Barangay</label>
                                        <p class="text-base text-gray-900">{{ $applicant->barangay ?: 'N/A' }}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Street</label>
                                        <p class="text-base text-gray-900">{{ $applicant->street ?: 'N/A' }}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Postal Code</label>
                                        <p class="text-base text-gray-900">{{ $applicant->postal_code ?: 'N/A' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('profile') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">
                                Update Profile
                            </a>
                        </div>
                    </div>
