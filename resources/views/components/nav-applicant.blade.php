         ...
         <ul class="space-y-2 font-medium">
            <li>
               <a href="{{ route('dashboard') }}"
                  ...
                  {{ request()->routeIs('dashboard') ? 'bg-[#0A6025] text-white' : 'text-white hover:bg-[#0A6025]' }}">
            ...
            <li>
               <a href="{{ route('apply-job') }}"
                  class="flex items-center p-3 rounded-lg
                  {{ request()->routeIs('apply-job') ? 'bg-[#0A6025] text-white' : 'text-white hover:bg-[#0A6025]' }}">
            ...
            <li>
               <a href="{{ route('notifications') }}"
                  class="flex items-center p-3 rounded-lg
                  {{ request()->routeIs('notifications') ? 'bg-[#0A6025] text-white' : 'text-white hover:bg-[#0A6025]' }}">
                  <i class="fa-solid fa-briefcase text-xl w-5 flex-shrink-0"></i>
                  <span class="ml-4 whitespace-nowrap 
                      block sm:hidden sm:group-hover:block
                      transition-all duration-300">
      ...
      <div class="mb-2 hidden sm:block relative">
        ...
        <div id="sidebarUserMenu" 
            ...
            <ul class="py-2 text-sm text-gray-700">
                <li><a href="{{ route('profile-view') }}" class="block px-4 py-2 hover:bg-gray-100">Settings</a></li>
            </ul>
            <div class="py-1">
