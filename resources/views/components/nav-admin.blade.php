         ...
         <ul class="space-y-2 font-medium">
            ...
            <li>
               <button @click="applicantOpen = !applicantOpen"
                  ...
                  <span class="ml-4 flex-1 block">Applicant</span>
            ...
            <li>
               <button @click="screeningOpen = !screeningOpen"
                  ...
                  <span class="ml-4 flex-1 block">Screening</span>
            ...
            <li>
               <button @click="managementOpen = !managementOpen"
                  ...
                  <span class="ml-4 flex-1 block">Management</span>
                  <i class="fa-solid fa-chevron-down text-xs transition-transform"
               ...
               <ul x-show="managementOpen" x-transition class="ml-8 mt-1 space-y-1 text-sm">
                  ...
                  <li>
                     <a href="{{ route('admin.position.rank') }}"
                        class="block p-2 rounded hover:bg-[#0A6025] text-white">
                        Position
                     </a>
                  </li>
      ...
      <div class="mb-2 relative">
         ...
         <div id="adminSidebarUserMenu"
            ...
            <ul class="py-2 text-sm text-gray-700">
               <li><a href="{{ route('admin.profile-view') }}" class="block px-4 py-2 hover:bg-gray-100">Settings</a>
               </li>
            </ul>
            <div class="py-1">
