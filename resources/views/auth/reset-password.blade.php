    ...
    <div class="lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div class="w-full max-w-md">
            ...
            <div class="flex justify-center mb-8">
                <img src="{{ asset('image/clsu-logo-green.png') }}" alt="CLSU Logo" class="h-24 w-24">
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" 
                               ...
                               class="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-150 ease-in-out @error('password') border-red-500 @enderror"
                ...
                <div class="text-center">
                    <a href="{{ route('login') }}" class="text-sm font-medium text-[#0A6025] hover:text-[#0B712C] transition duration-150 ease-in-out">
                        ← Back to Login
                    </a>
                </div>
            </form>
